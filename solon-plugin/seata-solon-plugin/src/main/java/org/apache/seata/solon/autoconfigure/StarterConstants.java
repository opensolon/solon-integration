...
public interface StarterConstants {
    ...
    String THREAD_FACTORY_PREFIX_KEBAB_STYLE = TRANSPORT_PREFIX + ".threadFactory";
    ...
    String LOAD_BALANCE_PREFIX_KEBAB_STYLE = CLIENT_PREFIX + ".loadBalance";
    ...
    String SAGA_STATE_MACHINE_PREFIX = SAGA_PREFIX + ".stateMachine";
    String SAGA_ASYNC_THREAD_POOL_PREFIX = SAGA_STATE_MACHINE_PREFIX + ".asyncThreadPool";
