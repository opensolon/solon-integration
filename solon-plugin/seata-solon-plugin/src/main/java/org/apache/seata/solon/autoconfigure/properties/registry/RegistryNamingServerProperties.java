...
import static org.apache.seata.solon.autoconfigure.StarterConstants.REGISTRY_NAMINGSERVER_PREFIX;

@Configuration
@Inject(value = "${" + REGISTRY_NAMINGSERVER_PREFIX + "}",required = false)
